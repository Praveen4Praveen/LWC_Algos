...
class Kyber:
    ...
    def enc(self, pk, key_length=32, random_bytes_length=32):
        """
        Algorithm 8 (CCA KEM Encapsulation)
        https://pq-crystals.org/kyber/data/kyber-specification-round3-20210804.>
        ...
        Output:
            ...
            K:  Shared key
        """
        m = self.random_bytes(random_bytes_length)
        print("Message: ", m)
        m_hash = self._h(m)
        print("Hashed Message: ", m_hash)
